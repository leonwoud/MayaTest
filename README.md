...
[![CI](https://github.com/leonwoud/MayaTest/actions/workflows/ci-main.yml/badge.svg)](https://github.com/leonwoud/MayaTest/actions/workflows/ci-main.yml)
...
<!-- PROJECT LOGO -->
<br />
  <a href="https://github.com/leonwoud/MayaTest">
...
<h3 align="center">MayaTest</h3>
  Test Matts Template
  <br />
  <p align="center">
    <a href="https://leonwoud.github.io/MayaTest"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/leonwoud/MayaTest">View Demo</a>
    ·
    <a href="https://github.com/leonwoud/MayaTest/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    ·
    <a href="https://github.com/leonwoud/MayaTest/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
1. Either clone the repo or download the zip file from the [project page][project-link] and extract it. 
    ```sh
    git clone https://github.com/leonwoud/MayaTest.git  
    ```
...
_For more examples, please refer to the [Documentation](https://leonwoud.github.io/MayaTest)._
...
See the [open issues](https://github.com/leonwoud/MayaTest/issues) for a full list of proposed features (and known issues).

<p align="right">(<a href="#readme-top">back to top</a>)</p>


## Contributing
If you have a suggestion that would make this better, please open an issue from the [request a feature](https://github.com/leonwoud/MayaTest/issues/new?labels=enhancement&template=feature-request---.md) or [report a bug](https://github.com/leonwoud/MayaTest/issues/new?labels=bug&template=bug-report---.md) pages.
...
Please reach out via the [request a feature](https://github.com/leonwoud/MayaTest/issues/new?labels=enhancement&template=feature-request---.md) or [report a bug](https://github.com/leonwoud/MayaTest/issues/new?labels=bug&template=bug-report---.md) pages.
...
[project-link]: https://github.com/leonwoud/MayaTest
